                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.business-settings.payment-method.update', ['digital_payment']) }}"
                        ...
                        @if (isset($config))
                            ...
                            <div class="d-flex flex-wrap gap-5">
                                <div class="d-flex gap-10 align-items-center mb-2">
                                    <input id="digital-payment-method-active" type="radio" name="status" value="1"
                                        {{ $config['status'] == 1 ? 'checked' : '' }}>
                                    <label for="digital-payment-method-active"
                                        class="title-color mb-0">{{ \App\CPU\translate('Active') }}</label>
                                </div>
                                <div class="d-flex gap-10 align-items-center mb-2">
                                    <input id="digital-payment-method-inactive" type="radio" name="status" value="0"
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.business-settings.payment-method.update', ['offline_payment']) }}"
                    ...
                    @if (isset($config))
                        ...
                        <div class="d-flex flex-wrap gap-5">
                            <div class="d-flex gap-10 align-items-center mb-2">
                                <input id="offline_payment-method-active" type="radio" name="status" value="1"
                                    {{ $config['status'] == 1 ? 'checked' : '' }}>
                                <label for="offline_payment-method-active"
                                    class="title-color mb-0">{{ \App\CPU\translate('Active') }}</label>
                            </div>
                            <div class="d-flex gap-10 align-items-center mb-2">
                                <input id="offline_payment-method-inactive" type="radio" name="status" value="0"
                                    {{ $config['status'] == 0 ? 'checked' : '' }}>
                ...
                <form action="{{ route('admin.business-settings.payment-method.update', ['ssl_commerz_payment']) }}"
                    ...
                    @if (isset($config))
                        ...
                        <div class="form-group">
                            <label class="d-flex title-color">{{ \App\CPU\translate('choose_environment') }}</label>
                            <select class="js-example-responsive form-control" name="environment">
                                <option value="sandbox" {{ $config['environment'] == 'sandbox' ? 'selected' : '' }}>
                                    {{ \App\CPU\translate('sandbox') }}</option>
                                <option value="live" {{ $config['environment'] == 'live' ? 'selected' : '' }}>
                                    {{ \App\CPU\translate('live') }}</option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label class="d-flex title-color">{{ \App\CPU\translate('Store') }}
                                {{ \App\CPU\translate('ID') }} </label>
    ...
    <div class="col-md-6">
        <div class="card h-100">
            <div class="card-body">
                ...
                <form action="{{ route('admin.business-settings.payment-method.update', ['paypal']) }}" method="post">
                    @csrf
                    @if (isset($config))
                        <center class="mb-3">
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-example-responsive form-control w-100" name="environment">
                                ...
                                <option value="sandbox"
                                    {{ isset($config['environment']) == true ? ($config['environment'] == 'sandbox' ? 'selected' : '') : '' }}>
                                    {{ \App\CPU\translate('sandbox') }}</option>
                                <option value="live"
                                    {{ isset($config['environment']) == true ? ($config['environment'] == 'live' ? 'selected' : '') : '' }}>
                                    {{ \App\CPU\translate('live') }}</option>
                        ...
                        <div class="form-group">
                            <label class="title-color d-flex">{{ \App\CPU\translate('Paypal') }}
                                {{ \App\CPU\translate('Client') }}{{ \App\CPU\translate('ID') }}</label>
                            <input type="text" class="form-control" name="paypal_client_id"
                                value="{{ env('APP_MODE') == 'demo' ? '' : $config['paypal_client_id'] }}">
                        </div>
                        <div class="form-group">
                            <label class="title-color d-flex">{{ \App\CPU\translate('Paypal') }}
                                {{ \App\CPU\translate('Secret') }} </label>
    ...
    <div class="col-md-6">
        <div class="card h-100">
            <div class="card-body">
                ...
                <form action="{{ route('admin.business-settings.payment-method.update', ['stripe']) }}" method="post">
                    @csrf
                    @if (isset($config))
    ...
    <div class="col-md-6" style="display:none;">
        <div class="card h-100">
            <div class="card-body">
                ...
                <form action="{{ route('admin.business-settings.payment-method.update', ['razor_pay']) }}" method="post">
                    @csrf
                    @if (isset($config))
                        @php($config['environment'] = $config['environment'] ?? 'sandbox')
                        <div class="d-flex flex-wrap gap-2 justify-content-between mb-3">
                    ...
                    @if (isset($config))
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control d-flex align-items-center justify-content-between py-1 pl-3 pr-2">
                                <span
                                    class="form-ellipsis {{ Session::get('direction') === 'rtl' ? 'text-right' : 'text-left' }}"
                        ...
                        <div class="form-group">
                            <label class="d-flex title-color">{{ \App\CPU\translate('secret') }}
                                {{ \App\CPU\translate('key') }}</label>
                            <input type="text" class="form-control" name="secret_key"
                                value="{{ env('APP_MODE') != 'demo' ? $config['secret_key'] : '' }}">
                        </div>

                        <div class="form-group">
                            <label class="d-flex title-color">{{ \App\CPU\translate('Merchant') }}
                                {{ \App\CPU\translate('ID') }}</label>
            ...
            <div class="card-body">
                ...
                <form
                    ...
                    @if (isset($config))
                        ...
                        <center class="mb-3">
                            <img height="60" src="{{ asset('/public/assets/back-end/img/paytabs.png') }}"
                                alt="">
                        </center>
            ...
            <div class="card-body">
                ...
                <form
                    ...
                    @if (isset($config))
                        ...
                        <center class="mb-3">
                            <img height="60" src="{{ asset('/public/assets/back-end/img/paystack.png') }}"
                                alt="">
                        </center>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control d-flex align-items-center justify-content-between py-1 pl-3 pr-2">
                                ...
                                <span class="btn btn--primary text-nowrap btn-xs"
                                    onclick="copyToClipboard('#id_paystack')"><i class="tio-copy"></i>
                                    {{ \App\CPU\translate('Copy URI') }}</span>
                            </div>
                        </div>
            ...
            <div class="card-body">
                ...
                <form
                    ...
                    @if (isset($config))
                        ...
                        <center class="mb-3">
                            <img height="60" src="{{ asset('/public/assets/back-end/img/paymob.png') }}"
                                alt="">
                        </center>
            ...
            <div class="card-body">
                ...
                <form
                    ...
                    @if (isset($config))
                        ...
                        <center class="mb-3">
                            <img height="60" src="{{ asset('/public/assets/back-end/img/fawry.svg') }}"
                                alt="">
                        </center>
            ...
            <div class="card-body">
                ...
                <form
                    ...
                    @if (isset($config))
                        ...
                        <center class="mb-3">
                            <img height="60" src="{{ asset('/public/assets/back-end/img/mercado.svg') }}"
                                alt="">
                        </center>
                        ...
                        <div class="form-group">
                            <label class="d-flex title-color">{{ \App\CPU\translate('access_token') }}</label>
            ...
            <div class="card-body">
                ...
                <form
                    ...
                    @if (isset($config))
                        ...
                        <center class="mb-3">
                            <img height="60" src="{{ asset('/public/assets/back-end/img/liqpay4.png') }}"
                                alt="">
                        </center>
                        ...
                        <div class="form-group">
                            <label class="d-flex title-color">{{ \App\CPU\translate('privateKey') }}</label>
            ...
            <div class="card-body">
                ...
                <form
                    ...
                    @if (isset($config))
                        ...
                        <center class="mb-3">
                            <img height="60" src="{{ asset('/public/assets/back-end/img/paytm.png') }}"
                                alt="">
                        </center>
            ...
            <div class="card-body">
                ...
                <form
                    ...
                    @if (isset($config))
                        ...
                        <center class="mb-3">
                            <img height="60" src="{{ asset('/public/assets/back-end/img/bkash.png') }}"
                                alt="">
                        </center>
