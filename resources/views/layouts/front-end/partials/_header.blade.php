        ...
        <div class="container">
            ...
            <div class="rightTop">
                ...
                <div class="saleLocation">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-secondary dropdown-toggle locaDiv" style="font-size: 15px;"
        ...
        <div class="navbar navbar-expand-md navbar-light navBarHeight">
            <div class="container " style="display:block !important;">
                ...
                <div class="row" style="align-items: center;">
                    ...
                    <div class="col-3">
                         <!-- Toolbar-->
                    <div class="navbar-toolbar cartAcc d-flex justify-content-end flex-shrink-0 align-items-center mt-3">
