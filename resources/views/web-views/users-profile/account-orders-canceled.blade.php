...
@section('content')
    ...
    <body>
        <div class="container my-3 top mt-5 orders">
            ...
            <div class="divIn">
                <div class="modalOuter" style="display: flex;align-items: center;">
                    <div class="modalDiv">

                        <button style="border: 1px solid; margin-top:10px; margin-right:5px;" type="button"
                            class="btn btnModal" data-toggle="modal" data-target="#exampleModal">
                                    ...
                                    <div class="modal-body">
                                        <div class="myAccountBar">
                                            ...
                                            <ul class="side">
                                                ...
                                                <li class="side-item"><a href="{{ route('track-order.index') }}">Track your
                                                        order</a></li>
                                                <li class="side-item"><a
                                                        href="{{ route('chat', ['type' => 'seller']) }}">Chat with
                                                        seller</a></li>
                                                <li class="side-item"><a href="{{ route('account-tickets') }}">Support
                                                        Ticket</a></li>
            ...
            <div class="row inner-content">
                <div class="account">
                    ...
                    <ul>
                        ...
                        <li class="side-item"><a href="{{ route('chat', ['type' => 'seller']) }}">Chat with seller</a>
                        </li>
                            ...
                            <div class="row order-row">
                                ...
                                <div class="col-3 col-md-3 order-num">
                                    ...
                                    <div class="__btn-grp-sm flex-nowrap">
                                        ...
                                        @else
                                            <button class="btn  __action-btn" title="{{ \App\CPU\translate('Cancel') }}"
                                                onclick="cancel_message()">
                                                <i class="fa fa-trash"></i>
                                            </button>
                                        @endif
                                    </div>
