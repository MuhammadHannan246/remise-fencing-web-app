...
//  Account Orders Pages
    Route::get('AllOrders', 'UserProfileController@Allaccount_oder')->name('');
    Route::get('ConfirmedOrders', 'UserProfileController@Confirmedaccount_oder')->name('');
    Route::get('PendingOrders', 'UserProfileController@Pendingaccount_oder')->name('');
    Route::get('CanceledOrders', 'UserProfileController@Canceledaccount_oder')->name('r');
